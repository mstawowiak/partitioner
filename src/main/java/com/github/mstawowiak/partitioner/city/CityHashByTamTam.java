...
/**
 * Derived from https://github.com/tamtam180/CityHash-For-Java
 *
 * @see http://google-opensource.blogspot.jp/2011/04/introducing-cityhash.html
 * @see http://code.google.com/p/cityhash/
 */
@SuppressWarnings({"PMD", "LocalVariableName", "ParameterName", "VariableDeclarationUsageDistance"})
public class CityHashByTamTam {
