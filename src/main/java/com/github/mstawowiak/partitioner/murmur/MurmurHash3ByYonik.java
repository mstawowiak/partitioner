 ...
 */
@SuppressWarnings({"PMD", "FallThrough", "ParameterName", "LocalVariableName", "VariableDeclarationUsageDistance"})
public final class MurmurHash3ByYonik {
